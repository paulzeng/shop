            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="userinfo">
                        {{d.nickname==null ? '暂无信息':d.nickname}}<br>{{d.user_phone}}<br>{{d.user_address}}/{{d.uid}}
                    </script>
                    <!--分销员信息-->
                    ...
                    <script type="text/html" id="info">
                        ...
                        <div>
                            ...
                            <span>{{item.cart_info.productInfo.store_name}}&nbsp;{{item.cart_info.productInfo.attrInfo.bar_code}}&nbsp;{{item.cart_info.productInfo.attrInfo.suk}}</span>
