...
class PublicController
{
	...
	*/
	public function getFrame(){
		$framewindow = GroupDataService::getData('routine_show_frame')?:[];
		return app('json')->successful(compact('framewindow'));
	}
	...
	*/
	public function getImgUrl(){
		$loginImg = GroupDataService::getData('routine_login_banner') ?: [];// 登陆页图片
		if(empty($loginImg)){
			$imgUrl = 'https://sm.c31rotc.com/uploads/attach/2019/11/20191112/show.jpg';
		}else{
			$imgUrl = $loginImg[0]['pic'];
		}
		return app('json')->successful(compact('imgUrl'));
	}
