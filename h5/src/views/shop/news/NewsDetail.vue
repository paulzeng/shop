<template>
  <div class="newsDetail">
    ...
    <div class="picTxt acea-row row-between-wrapper">
      <div class="pictrue"><img src="../../../assets/images/value.jpg" /></div>
      <div class="text">
        <div class="name line1">严选精品瓷器珐琅搪瓷马克杯</div>
        <div class="money font-color-red">
          ￥<span class="num">199.00</span>
        </div>
        <div class="y_money">￥200.00</div>
      </div>
      <div class="label"><span class="span">查看商品</span></div>
    </div>
    <div class="bnt bg-color-red">和好友一起分享</div>
  </div>
</template>
<style scoped>
.newsDetail .picTxt {
